...
const categories = [
  { label: "All Articles", slug: "all", active: true },
  { label: "Reading Tips", slug: "reading-tips", active: false },
  { label: "Book Reviews", slug: "book-reviews", active: false },
  { label: "Seller Guide", slug: "seller-guide", active: false },
  { label: "Buyer Guide", slug: "buyer-guide", active: false },
  { label: "Free Ebooks", slug: "free-ebooks", active: false },
  { label: "Community", slug: "community", active: false },
];
    ...
    <main className="min-h-screen bg-gray-950 overflow-x-hidden">
      ...
      <section className="w-[90%] max-w-7xl mx-auto px-4 pt-14 pb-4">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <p className="text-[10px] font-bold tracking-[0.3em] text-violet-400 uppercase">Featured Article</p>
        </div>
        ...
        <div className="group relative bg-white/[0.03] border border-white/[0.07] rounded-sm overflow-hidden cursor-pointer hover:border-violet-500/30 transition-all duration-500 hover:shadow-[0_0_80px_rgba(139,92,246,0.08)]">
          <div className="flex flex-col md:flex-row items-stretch min-h-[300px]">
            ...
            {/* Image column */}
            <div className="relative md:w-[300px] flex-shrink-0 h-[200px] md:h-auto overflow-hidden p-6">
              <Image
                src={featuredPost.imageSrc}
                alt={featuredPost.title}
                fill
                className="object-contain grayscale group-hover:grayscale-0 transition-all duration-700 p-20"
                priority
              />
              {/* Gradient overlays */}
            ...
            <div className="flex-1 p-8 md:p-10 lg:p-12 flex flex-col justify-between">
              <div>
                ...
                {/* Excerpt */}
                <p className="text-white/45 text-sm leading-relaxed line-clamp-3 mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {featuredPost.tags.map((tag) => (
                    <span key={tag} className="px-2.5 py-1 bg-white/[0.04] border border-white/[0.07] text-white/35 text-[10px] font-medium rounded-sm">
                      #{tag}
                    </span>
                  ))}
                </div>
              ...
              <div className="flex items-center justify-between pt-6 mt-6 border-t border-white/[0.07]">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-white/60 text-xs font-semibold">{featuredPost.author}</p>
                ...
                >
                  Read Article
                  <svg className="w-3.5 h-3.5 translate-x-0 group-hover/btn:translate-x-1 transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <section className="w-[90%] max-w-7xl mx-auto px-4 pt-14 pb-6">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <p className="text-[10px] font-bold tracking-[0.3em] text-white/35 uppercase">Latest Articles</p>
          </div>
          <span className="text-[11px] text-white/20 font-medium">{blogPosts.length} articles</span>
        </div>
            ...
            >
              ...
              <div className="relative h-40 overflow-hidden flex-shrink-0">
                ...
                <div className="absolute top-3 left-3">
                  <span className={`px-2.5 py-1 border rounded-sm text-[9px] font-bold tracking-[0.15em] uppercase ${post.tagColor}`}>
                    {post.tag}
                  </span>
                </div>
                ...
                <div className="absolute top-3 right-3 flex items-center gap-1 px-2 py-1 bg-black/50 backdrop-blur-sm rounded-sm">
                  ...
                  <span className="text-[9px] text-white/50 font-semibold">{post.readTime}</span>
                </div>
              </div>
              ...
              <div className="flex flex-col flex-1 p-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-white/30 text-[10px] font-medium">{post.author}</span>
                  </div>
                  ...
                  >
                    Read
                    <svg className="w-3 h-3 translate-x-0 group-hover/link:translate-x-0.5 transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
                    </svg>
                  </Link>
                </div>
