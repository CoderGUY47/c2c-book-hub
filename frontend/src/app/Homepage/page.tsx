...
import BrowseGenresSection from "../components/BrowseGenresSectionV2";
            ...
            <section className="relative h-[603px] overflow-hidden -mt-[1px] z-0">
                ...
                <div className="relative flex flex-col w-[80%] mx-auto px-0 h-full items-center justify-center text-white text-center">
                    <h1 className="text-4xl md:text-6xl max-w-4xl mx-auto font-black font-poppins mb-4">
                        The{" "}
                        <span className="text-transparent bg-clip-text bg-gradient-to-tl from-amber-600 to-red-600">
                            New
                        </span>{" "}
                        Online Buying & Selling Book Hub in Bangladesh
                    </h1>
                    ...
                    <div className="w-[80%] mx-auto px-4">
                        <div className="text-center mb-16">
                            <h2 className="text-4xl md:text-5xl font-poppins font-black mb-4 text-white tracking-tighter">
                                How to
                                <span className="text-transparent bg-clip-text bg-gradient-to-tl from-red-600 to-orange-400">
                                    {" "}
                                    SELL{" "}
                                </span>
                                Your Used Books in
                                <span className="text-transparent bg-clip-text bg-gradient-to-tl from-indigo-600 to-violet-500">
                                    {" "}
                                    Book-Hub?
                                </span>
                            </h2>
                            <p className="text-gray-400 max-w-2xl mx-auto text-lg font-medium">
                                Turn your bookshelf into a goldmine with these 3-step selling
                                process.
                            </p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-4">
                            {sellSteps.map((step, index) => (
                                <div
                                    key={index}
                                    className="group relative w-full aspect-[3/4] md:aspect-auto md:h-[420px] flex justify-center p-2"
                                >
                ...
                <section className="py-15 bg-transparent">
                    <div className="w-[80%] mx-auto px-4">
                        <h2 className="text-5xl text-white font-poppins font-black text-center mt-8 mb-20">
                            Read our{" "}
                            <span className="text-transparent bg-clip-text bg-gradient-to-tl from-indigo-600 to-sky-600">
                                Blog
                            </span>
                        </h2>
