      ...
      <div className="container relative z-10 w-[80%] mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg md:text-xl font-medium max-w-2xl mx-auto leading-relaxed">
            Welcome to <span className="text-white font-bold">Book-Hub</span>, your best destination for buying and selling used books online. We believe every book has a second story to tell.
          </p>
        </div>
          ...
          {[
            {
              ...
              title: "Our Mission",
              desc: "Our mission at Book-Hub is to provide a platform where people can easily buy and sell their used books and make reading accessible to everyone."
            },
            {
              icon: <Users className="w-12 h-12 text-purple-400" />,
              title: "Our Community",
              desc: "We believe in building a community of book lovers who can share their passion for reading alongside eco-friendly practices."
            },
            {
              icon: <ShieldCheck className="w-12 h-12 text-blue-400" />,
              title: "Our Commitment",
              desc: "We are committed to providing a secure transaction platform and ensuring customer satisfaction at every step."
            }
          ].map((item, idx) => (
            <div key={idx} className="group relative bg-white/5 backdrop-blur-xl border border-white/10 p-10 rounded-[2.5rem] transition-all duration-500 hover:bg-white/10 hover:border-indigo-500/50 hover:shadow-[0_0_50px_rgba(79,70,229,0.2)]">
              ...
              <h2 className="text-2xl font-black text-center mb-4 text-white uppercase tracking-wide">
                {item.title}
              </h2>
        ...
        <section className="py-20 relative px-0 bg-transparent">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            {[
              { emoji: "📚", title: "Vast Collection", desc: "Thousands of used books at your fingertips." },
              { emoji: "📝", title: "Easy Listing", desc: "Sell your used books in just a few clicks." },
              { emoji: "🔒", title: "Secure Transactions", desc: "Secure payment methods ensure your peace of mind." },
              { emoji: "🤝", title: "Community Driven", desc: "Join a community of readers and sellers who love books as much as you do." }
            ].map((feature, idx) => (
              <div key={idx} className="bg-white/5 backdrop-blur-md rounded-3xl p-8 border border-white/5 hover:bg-gray-800/40 transition-all duration-500 group hover:-translate-y-2">
                ...
                <h3 className="font-black text-md text-center mb-3 text-white uppercase tracking-wide">
                  {feature.title}
                </h3>
        ...
        <div className="text-center py-10 bg-gradient-to-tr from-slate-900/80 via-gray-600/30 to-slate-900/80 rounded-[4rem] border-0 backdrop-blur-xl">
          ...
          <p className="text-gray-300 text-md md:text-lg font-medium mb-4 max-w-[600px] mx-auto">
            Sign up now to start buying and selling your favorite books on <span className="text-white font-bold">Book-Hub</span>!
          </p>
