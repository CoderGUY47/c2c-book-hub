...
/*\\\\ ** product related urls **////////*/
    ...
    DELETE_PRODUCT_BY_PRODUCT_ID: (productId:string) => `/api/products/delete/${productId}`,
...
/*\\\\ ** order related urls **////////*/
    ...
    // CREATE_SSL_PAYMENT: `/api/order/ssl/payment`,
...
export const api = createApi({
    ...
    endpoints:(builder)=>({
        ...
        getProducts:builder.query({   //go to server, modify the data
            query:() =>
                API_URLS.PRODUCTS,
        ...
        createSslcommerzPayment: builder.mutation({
            query: (orderData) => ({
                url: API_URLS.INIT_SSL_PAYMENT,
                method: 'POST',
                body: orderData, // Pass the full order data (totalAmount, shippingAddress, etc)
            }),
        }),
