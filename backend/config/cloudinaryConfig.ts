...
const multerMiddleware: RequestHandler = multer({ dest: '/tmp/' }).array('images',4); //dest is the folder name where images are stored temporarily and 4 images can be uploaded at a time
